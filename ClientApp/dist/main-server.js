...
var SignInUpService = (function () {
    function SignInUpService(http, router) {
        this.http = http;
        this.router = router;
        this.baseUrl = "/account";
    }
    SignInUpService.prototype.signInService = function (model) {
        return this.http.post(this.baseUrl + "/token", model)
            .toPromise()
            .then(function (response) { return response.json().data; })
            .catch(function (err) { return console.log(err); });
    };
    SignInUpService.prototype.signUpService = function (model) {
        var _this = this;
...
SignInUpService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http, router_1.Router])
], SignInUpService);
exports.SignInUpService = SignInUpService;
...
var signin_up_component_1 = __webpack_require__(20);
var signin_up_service_1 = __webpack_require__(4);
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            ...
            signin_up_component_1.SignInUpComponent
        ],
        imports: [
            http_1.HttpModule,
            ...
            router_1.RouterModule.forRoot([
                ...
                { path: 'signin', component: signin_up_component_1.SignInUpComponent },
                { path: 'signup', component: signin_up_component_1.SignInUpComponent },
                { path: '**', redirectTo: 'home' }
            ]),
            forms_1.FormsModule
        ],
        providers: [signin_up_service_1.SignInUpService]
    })
], AppModule);
...
(function (global, factory) {
     true ? factory(exports, __webpack_require__(1), __webpack_require__(5), __webpack_require__(35), __webpack_require__(6), __webpack_require__(34)) :
...
var core_1 = __webpack_require__(1);
var signin_up_service_1 = __webpack_require__(4);
var SignInUpComponent = (function () {
    function SignInUpComponent(service) {
    ...
    SignInUpComponent.prototype.signInView = function () {
        this.signInDisplayed = true;
        this.signInShow = "tab active";
        this.signInHide = "tab";
    };
    SignInUpComponent.prototype.signUpView = function () {
        this.signInDisplayed = false;
        this.signInShow = "tab";
        this.signInHide = "tab active";
    };
    SignInUpComponent.prototype.signIn = function (form) {
        if (form.valid) {
            var model = form.value;
            this.service.signInService(model);
        }
    };
    SignInUpComponent.prototype.signUp = function (form) {
        if (form.valid) {
            var model = form.value;
            console.log("Sign Up");
...
SignInUpComponent = __decorate([
    core_1.Component({
        selector: 'signin-up',
        template: __webpack_require__(28),
        styles: [__webpack_require__(33)]
    }),
    __metadata("design:paramtypes", [signin_up_service_1.SignInUpService])
], SignInUpComponent);
exports.SignInUpComponent = SignInUpComponent;
...
module.exports = "<div class='main-nav'>\r\n    <div class='navbar navbar-inverse'>\r\n        <div class='navbar-header'>\r\n            <button type='button' class='navbar-toggle' data-toggle='collapse' data-target='.navbar-collapse'>\r\n                <span class='sr-only'>Toggle navigation</span>\r\n                <span class='icon-bar'></span>\r\n                <span class='icon-bar'></span>\r\n                <span class='icon-bar'></span>\r\n            </button>\r\n            <a class='navbar-brand' [routerLink]=\"['/home']\">MockPrj</a>\r\n        </div>\r\n        <div class='clearfix'></div>\r\n        <div class='navbar-collapse collapse'>\r\n            <ul class='nav navbar-nav'>\r\n                <li [routerLinkActive]=\"['link-active']\">\r\n                    <a [routerLink]=\"['/home']\">\r\n                        <span class='glyphicon glyphicon-home'></span> Home\r\n                    </a>\r\n                </li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</div>\r\n";

/***/ }),
/* 28 */
/***/ (function(module, exports) {

module.exports = "<div class=\"form\">\r\n\r\n    <ul class=\"tab-group\">\r\n        <li [ngClass]=\"signInHide\"><a (click)=\"signUpView()\">Sign Up</a></li>\r\n        <li [ngClass]=\"signInShow\"><a (click)=\"signInView()\">Sign In</a></li>\r\n    </ul>\r\n\r\n    <div class=\"tab-content\" >\r\n        <div id=\"login\" *ngIf=\"signInDisplayed\">\r\n            <h1>Welcome Back!</h1>\r\n            <form (ngSubmit)=\"signIn(signInForm)\" action=\"token\" method=\"post\"\r\n             #signInForm=\"ngForm\">\r\n                <div class=\"field-wrap\">\r\n                    <label class=\"active highlight\">\r\n                        Email Address<span class=\"req\">*</span>\r\n                    </label>\r\n                    <input name=\"email\" type=\"email\" required autocomplete=\"off\"  ngModel>\r\n                </div>\r\n                <div class=\"field-wrap\">\r\n                    <label class=\"active highlight\">\r\n                        Password<span class=\"req\">*</span>\r\n                    </label>\r\n                    <input name=\"password\" type=\"password\" required autocomplete=\"off\" ngModel>\r\n                </div>\r\n                <p class=\"forgot\"><a href=\"/forgetpwd\">Forgot Password?</a></p>\r\n                <button type=\"submit\" class=\"button button-block\">Sign In</button>\r\n            </form>\r\n        </div>\r\n        <div id=\"signup\" *ngIf=\"!signInDisplayed\">\r\n            <h1>Sign Up for Free</h1>\r\n            <form #signUpForm=\"ngForm\" action=\"register\" method=\"post\"\r\n                  (ngSubmit)=\"signUp(signUpForm)\">\r\n                <div class=\"top-row\">\r\n                    <div class=\"field-wrap\">\r\n                        <label class=\"active highlight\">\r\n                            First Name<span class=\"req\">*</span>\r\n                        </label>\r\n                        <input name=\"firstname\" type=\"text\" required autocomplete=\"off\" ngModel>\r\n                    </div>\r\n\r\n                    <div class=\"field-wrap\">\r\n                        <label class=\"active highlight\">\r\n                            Last Name<span class=\"req\">*</span>\r\n                        </label>\r\n                        <input name=\"lastname\" type=\"text\" required autocomplete=\"off\" ngModel>\r\n                    </div>\r\n                </div>\r\n                <div class=\"field-wrap\">\r\n                    <label class=\"active highlight\">\r\n                        Email Address<span class=\"req\">*</span>\r\n                    </label>\r\n                    <input name=\"email\" type=\"email\" required autocomplete=\"off\" ngModel>\r\n                </div>\r\n                <div class=\"field-wrap\">\r\n                    <label class=\"active highlight\">\r\n                        Set A Password<span class=\"req\">*</span>\r\n                    </label>\r\n                    <input name=\"password\" type=\"password\" required autocomplete=\"off\" ngModel>\r\n                </div>\r\n                <button type=\"submit\" class=\"button button-block\">Get Started</button>\r\n            </form>\r\n        </div>\r\n    </div><!-- tab-content -->\r\n\r\n</div>";
...
var toPromise_1 = __webpack_require__(5);
